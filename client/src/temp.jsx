...
const PortfolioData = {
  ...
  loader: {
    ...
    logoUrl: "../../public/karan_freelancing_logo.svg",
  ...
  if (status === 'sent') {
    content = (
      <div className="text-center p-8">
        ...
        <h3 className="text-3xl font-extrabold text-[var(--accent-blue)] mb-2">Transmission Acknowledged.</h3>
        <p className="text-gray-300">Your message is routed. I will initiate the return sequence shortly.</p>
